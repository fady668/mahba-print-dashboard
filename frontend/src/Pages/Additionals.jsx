...
const Additionals = () => {
  ...
  const [totalAdditionalsMoney, setTotalAdditioansMoney] = useState(
    parseFloat(0)
  );
    ...
    <div className="additionals-page">
      ...
      <div className="page-content">
        ...
        <div className="total-cash not-border">
          <span>اجمالي حساب الاضافات</span>
          <span className="heighlight-text">{totalAdditionalsMoney}</span>
        </div>
